...
[![Tests](https://img.shields.io/badge/tests-405%20passed-brightgreen.svg)](#测试)
...
| 类型 | 数量 | 说明 |
|------|------|------|
| 后端单元/集成测试 | 240 | 覆盖 API / Services / Core / Agent / Utils 各层（含 users / RBAC / email_template / qa 意图 / 4 维度评分 / 看板扩展） |
